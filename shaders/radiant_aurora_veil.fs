/*{
  "CATEGORIES": ["Radiant", "Nature", "Noise"],
  "DESCRIPTION": "Northern lights aurora borealis with 7 ribbon layers, twinkling stars, ice crystal ground, and reflections. From Radiant by Paul Bakaus (MIT).",
  "INPUTS": [
    { "NAME": "auroraSpeed", "LABEL": "Aurora Speed", "TYPE": "float", "MIN": 0.1, "MAX": 1.5, "DEFAULT": 0.5 },
    { "NAME": "auroraIntensity", "LABEL": "Intensity", "TYPE": "float", "MIN": 0.3, "MAX": 2.0, "DEFAULT": 1.0 },
...
// Aurora Veil - Radiant Shaders Gallery (MIT License)
...
void main() {
    ...
    float i1 = r1 * 1.4 * audioIntensity;
    float i2 = r2 * 1.1 * audioIntensity;
    float i3 = r3 * 0.9 * audioIntensity;
    float i4 = r4 * 0.5 * audioIntensity;
    float i5 = r5 * 0.8 * audioIntensity;
    float i6 = r6 * 0.6 * audioIntensity;
    float i7 = r7 * 0.35 * audioIntensity;
    ...
    if (groundFade > 0.001) {
        ...
        crystalUV.x += t * 0.02;
        float crystal = crystalPattern(crystalUV, TIME);
        ...
        reflectionColor *= audioIntensity * pulse;
